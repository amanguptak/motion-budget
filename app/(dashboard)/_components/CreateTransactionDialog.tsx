...
// function CreateTransactionDialog({ trigger, type ,transactionId}: Props) {
...
//     fetchTransaction();
//   } else {
//     // If creating a new transaction, reset the form
//     form.reset({
//       type,
//       date: new Date(),
//       description: "",
...
//         return axios.patch(`/api/transactions/${transactionId}`, values);
//       },
//       onSuccess: () => {
...
//       }
//     },
//     [mutate, updateMutation, transactionId]
//   );
